...
<i class="fa-solid fa-file-pdf"></i> [Read the Paper (PDF)](chile-neoliberal-reforms.pdf) |
<i class="fa-solid fa-file-code"></i> [View the R Code (.rmd)](chile-neoliberal-reforms.rmd) |
