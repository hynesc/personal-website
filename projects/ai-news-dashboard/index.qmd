...
project:
  ...
  links:
    - icon: "globe"
      name: "Live Dashboard"
      url: "https://ai-news-dashboard.streamlit.app/"
    - icon: "github"
      name: "GitHub Repo"
      url: "https://github.com/hynesc/ai-news-dashboard"
---
...
Below is the live, interactive dashboard, hosted on Streamlit Community Cloud. The data is updated automatically every 24 hours.

```{=html}
<div style="border: 1px solid #ddd; border-radius: 8px; overflow: hidden; margin-bottom: 20px;">
<iframe
  src="[https://ai-news-dashboard.streamlit.app/?embed=true](https://ai-news-dashboard.streamlit.app/?embed=true)"
  height="800"
...
Conclusion
This project demonstrates an end-to-end data science workflow, from automated data acquisition and NLP analysis to deployment of an interactive web application. By focusing on the strategic domain of AI safety and governance, it serves
